...
class DonatePageConstants {
  static const double buttonsWidth = 300;
  static const paddings = EdgeInsets.all(22);
  static const uMoneyUrl = '';
  static const pageTitle = 'Donate';
